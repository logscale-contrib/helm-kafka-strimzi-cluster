...
helm upgrade --install --create-namespace --namespace strimzi strimzi/strimzi-kafka-operator --version ${V_STRIMZI_OPERATOR:-0.37.0} -f .kind/strimzi-operator-values.yaml --wait
